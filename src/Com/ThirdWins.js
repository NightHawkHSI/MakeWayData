...
function ThirdWins({ data }) {
  ...
  useEffect(() => {
    if (data.length > 0) {
      ...
      const ctx = document.getElementById('ThirdPlace').getContext('2d');
  ...
  return <canvas id="ThirdPlace" width="400" height="400" />;
}

export default ThirdWins;